...
(
    ...
    CT_code CHAR(2) NOT NULL UNIQUE
);
...
(
    RSVS_id NUMBER DEFAULT payment_status_seq.nextval PRIMARY KEY,
...
(
    ...
    RSV_guest_count    NUMBER(2) CHECK (RSV_guest_count > 0), RM_id              NUMBER NOT NULL,
    USR_id             NUMBER NOT NULL,
    RSVS_id            NUMBER NOT NULL,
    FOREIGN KEY (RM_id) REFERENCES Rooms (RM_id),
    FOREIGN KEY (USR_id) REFERENCES Users (USR_id),
    FOREIGN KEY (RSVS_id) REFERENCES Reservation_statuses(RSVS_id)
);
